...
  const ayinPriceInfo = await getTokenPriceInfo();
  const ayinPrice = ayinPriceInfo.price;
  
  const ayinPriceToken = ayinPriceInfo.priceToken;
  
  addCrypto(ayinImage, `${ayinPriceToken} ALPH`, `$${ayinPrice} USD`);
}
...
  const url = 'https://api.mobula.io/api/1/market/pair?blockchain=alephium&address=25ywM8iGxKpZWuGA5z6DXKGcZCXtPBmnbQyJEsjvjjWTy';
