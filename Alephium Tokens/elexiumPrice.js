...
// Function to fetch ALPH to USD conversion rate from Coinpaprika API
async function getUSDConversionRate() {
  const url = 'https://api.coinpaprika.com/v1/tickers/alph-alephium';
  const response = await new Request(url).loadJSON();
  return response.quotes.USD.price;
}
