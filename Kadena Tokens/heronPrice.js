...
widget.url = 'https://mercatus.works/?token0=KDA&token1=HERON';
...
  const heronImage = await loadImage('https://raw.githubusercontent.com/CryptoPascal31/kadena_tokens/main/img/heron.png');
...
  const url = 'https://api.coinpaprika.com/v1/tickers/kda-kadena';
  const req = new Request(url);
  const apiResult = await req.loadJSON();
  return apiResult['quotes']['USD']['price'];
}
