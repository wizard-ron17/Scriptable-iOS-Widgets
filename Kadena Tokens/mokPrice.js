...
const headerText = headerStack.addText("$MOK Price");
...
  const wizaImage = await loadImage('https://assets.kdlaunch.com/tokens/mok-logo.png');
...
  const url = 'https://kdswap-fd-prod-cpeabrdfgdg9hzen.z01.azurefd.net/graphql?query={price(token:"mok.token", period:1){id,timestamp,token,price,priceInKda,intervalStamp}}';
